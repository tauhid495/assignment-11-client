        ...
        <>
            <footer className="md:flex justify-between  bg-base-black text-white py-7">
                ...
                <div className='ml-4 md:mr-16'>
                    ...
                    <div>
                        <h1>Contact Us :</h1>
                        <p>House : 72/a, Road No : 7, <br />
                            Prosanti R/A, Cornel Hat, <br />
                            North Kattoli, Chittagon.
                        </p>
                        <p>Cell# +88 01755338813</p>
                        <p>Feel free to mail : <a href="mailto:tauhid495@gmail.com"> Click Here </a></p>
                    </div>
                </div>
